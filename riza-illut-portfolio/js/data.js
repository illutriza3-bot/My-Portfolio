...
const SITE_DATA = {
  ...
  person: {
    ...
    // The "Leave feedback" form sends submissions here so they land in your
    // inbox automatically. To set it up (free, ~2 minutes):
    //   1. Go to formspree.io and sign up with your email.
    //   2. Click "New Form", name it anything (e.g. "Portfolio Feedback").
    //   3. Copy the endpoint URL it gives you — looks like
    //      https://formspree.io/f/abcdwxyz — and paste it below.
    //   4. Save this file, redeploy, then submit the form once yourself.
    //      Formspree emails you a one-time confirmation link the first
    //      time — click it to activate the form. After that, every
    //      submission arrives in your inbox automatically.
    // Leave this blank and the form will fall back to opening an email
    // draft instead (the mailto: behavior from before).
    feedbackFormEndpoint: "https://formspree.io/f/meaqzpqy"
  },
